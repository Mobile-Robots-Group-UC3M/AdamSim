...
# Import object
object_path = os.path.join("/workspace/data/models/milk.stl")
import_object(object_path, [[0.55, 0.03, 0.85], p.getQuaternionFromEuler([0,0,0])])
...
# Open hands
adam.grippers.set_pos('right', 0.0, normalised=True)
...
while True:
    ...
    adam.grippers.close_with_force_limit('right', target_torque=10)
    adam.wait(3)

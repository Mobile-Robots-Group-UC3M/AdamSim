...
if __name__ == '__main__':
    ...
    while (1):
        ...
        """ print("Valor de key:",keys.items())
        print("Valor real:",p.B3G_RIGHT_ARROW) """
        ...
        p.setJointMotorControl2(adam.robot_id,4,p.VELOCITY_CONTROL,targetVelocity=leftWheelVelocity,force=1000)
        p.setJointMotorControl2(adam.robot_id,3,p.VELOCITY_CONTROL,targetVelocity=rightWheelVelocity,force=1000)
